...
@section('view')
    <div class="w-full h-screen relative">
        ...
        <div
            class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[50%] h-screen bg-white flex justify-center items-center">
            <div class=" justify-center flex flex-col items-center w-[80%]">
                ...
                <form class="form-filament" method="POST" action="{{ route('entri-data.login') }}">
                    @csrf
                    ...
                    <p class="text-center mt-4">lupa password? <a href="{{ route('forgot-password') }}"
                            class="text-blue-600">klik di sini</a></p>
