            ...
            <div class="bg-white rounded-xl justify-between flex p-5 shadow border items-center">
                ...
                <div class="flex gap-3 items-center">
                    @if ($dashboardPdrb->detaildashboardPdrb)
                        ...
                        <x-filament::modal id="confirm-delete-{{ $dashboardPdrb->id }}">
                            <x-slot name="trigger">
                            ...
                            <x-slot name="footer">
                                <div class="flex justify-between">
                                    <x-filament::button color="gray"
                                        x-on:click="$dispatch('close-modal', { id: 'confirm-delete-{{ $dashboardPdrb->id }}' })">
                                        Batal
                                    </x-filament::button>

                                    <x-filament::button color="danger" wire:click="delete({{ $dashboardPdrb->id }})">
                                        Ya, Hapus
                                    </x-filament::button>
                                </div>
                            </x-slot>
                            ...
                            <div class="">
                                Apakah Anda yakin ingin menghapus data <strong>{{ $dashboardPdrb->tahun }}</strong>?
                            </div>
