                    ...
                    @for ($i = 1; $i <= 4; $i++)
                        <div class="mb-3">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                @for ($j = 1; $j <= 3; $j++)
                                    <input type="number" value="{{ $dashboardPdrb->{'sektor_pengeluaran_'.$i.'_'.$j} }}" readonly
                                        class="mt-1 mb-5 block w-full border-gray-300 rounded-md shadow-sm bg-gray-100" />
                                @endfor
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="number" value="{{ $dashboardPdrb->{'adhb_komp'.$i} }}" readonly
                                        class="mt-1 mb-5 block w-full border-gray-300 rounded-md shadow-sm bg-gray-100" />
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700">ADHK</label>
                                    <input type="number" value="{{ $dashboardPdrb->{'adhk_lapangan_usaha_'.$i} }}" readonly
                                        class="mt-1 mb-5 block w-full border-gray-300 rounded-md shadow-sm bg-gray-100" />
                                </div>
                            </div>
                        </div>
