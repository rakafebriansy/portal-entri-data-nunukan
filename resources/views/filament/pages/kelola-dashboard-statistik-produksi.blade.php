            ...
            <div class="bg-white rounded-xl justify-between flex p-5 shadow border items-center">
                ...
                <div class="flex gap-3 items-center">
                    @if ($dashboardSp->detailDashboardSp)
                        <a href="{{ route('filament.dashboard.sp.detail', ['id' => $dashboardSp->id]) }}"
                        ...
                        <form action="{{ route('filament.dashboard.sp.delete', ['id' => $dashboardSp->id]) }}"
                            method="POST" onsubmit="return confirm('Yakin ingin menghapus data ini?');" class="flex justify-center items-center">
                            @csrf
                            @method('DELETE')
                            <button type="submit">
                                <svg width="34" height="33" viewBox="0 0 34 33" fill="none"
