            ...
            <div class="bg-white rounded-xl justify-between flex p-5 shadow border items-center">
                ...
                <div class="flex gap-3 items-center">
                    @if ($dashboardSp->detailDashboardSp)
                        ...
                        <x-filament::button color="red" wire:click="delete({{ $dashboardSp->id }})" style="padding: 0;"><svg width="34"
                                height="33" viewBox="0 0 34 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
